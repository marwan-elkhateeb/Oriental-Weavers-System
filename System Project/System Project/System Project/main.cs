...
namespace System_Project
{
    public partial class main : Form
    {
        ...
        public class Employee : Management
        {
            ...
            public void setEntryDates(string X, int i, int j)
            {
                this.EntryDates[i][j] = X;
            }

            public string getEntryDates(int i, int j)
            {
                return this.EntryDates[i][j];
            }

            public void setLeaveDates(string X, int i, int j)
            {
                this.LeaveDates[i][j] = X;
            }

            public string getLeaveDates(int i, int j)
            {
                return this.LeaveDates[i][j];
            }
        ...
        public class Bill
        {
            ...
            public int calculate_order(Order O)
            {
                return 0;
            }
        ...
        public class Order
        {
            ...
            public Bill CarpetBill(Carpets C, Bill B)
            {
                return B;
            }
